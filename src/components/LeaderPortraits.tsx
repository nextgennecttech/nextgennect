...
import aliyanShah from 'src/assets/leaders/aliyan.jpg';
import muhammadAtif from 'src/assets/leaders/atif.jpg';
import fatimaZahra from 'src/assets/leaders/fatima.jpg';
